...
-- AddForeignKey
ALTER TABLE "Chat" ADD CONSTRAINT "Chat_latstMessageId_fkey" FOREIGN KEY ("latstMessageId") REFERENCES "Message"("id") ON DELETE SET NULL ON UPDATE CASCADE;
